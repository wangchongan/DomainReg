package com.jinmibao.biz.dataobject.common;
...
public class SysConfigDO implements Serializable {
    ...
    private static final long serialVersionUID = 133476348989173744L;
    ...
    public SysConfigDO(Long id, Date gmtCreate, Date gmtModified, String name, String value, String groupName, String remark) {
        this.id = id;

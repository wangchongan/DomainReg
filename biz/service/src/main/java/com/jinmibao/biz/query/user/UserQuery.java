package com.jinmibao.biz.query.user;
...
public class UserQuery implements Serializable {
    ...
    private static final long serialVersionUID = 133597358543108202L;
    ...
    public UserQuery(Long id, Date gmtCreate, Date gmtModified, Long creator, Long modifier, String userNick, String userPsw, String email, String regIp, String mobile, String hasBuyApp, Date gmtLastLogin, String lastLoginIp, Date gmtCurrentLogin, String currentLoginIp, Long loginCount, String websiteUrl, String status) {
        this.id = id;

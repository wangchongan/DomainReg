 ...
 * @author wangchongan
 */
public class PinyinDO implements Serializable {

    private static final long serialVersionUID = 133492678190049625L;
    ...
    public PinyinDO(Long id, Date gmtCreate, Date gmtModified, String pinyin, String chinese, String startWith, Long allLength, String isYuanyin, Long num, Long first, String firstPinyin, Long second, String secondPinyin, Long third, String thirdPinyin, Long fourth, String fourthPinyin, Long hot) {
        this.id = id;

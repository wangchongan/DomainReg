package com.jinmibao.biz.dataobject.domain;
 ...
 * @author wangchongan
 */
public class DomainDeletedDO implements Serializable {

    private static final long serialVersionUID = 133476348937615834L;
    ...
    /**
     * column jmb_domain_deleted.pinyin_id
     */
    private String            pinyinChinese;
    ...
    private String            gmtPlanDeletedStr;

    private String            domain;

    // 是否已经被删除了，如果计划删除时间超过了当前时间，则被删了
    private String            isAlreadyDeleted;

    private String            allFirstChinese;

    public DomainDeletedDO(){
        super();
    }
    ...
    public void setPinyinChinese(String pinyinChinese) {
        this.pinyinChinese = pinyinChinese;
    }
    ...
    public String getGmtPlanDeletedStr() {
        return DateUtil.date2String(this.gmtPlanDeleted, DateUtil.DAY_DATE_FORMAT);
    }

    public void setGmtPlanDeletedStr(String gmtPlanDeletedStr) {
        this.gmtPlanDeletedStr = gmtPlanDeletedStr;
    }
    ...
    public String getIsAlreadyDeleted() {
        if (new Date().after(gmtPlanDeleted)) {
            this.isAlreadyDeleted = CommonConstant.YES;
        } else {
            this.isAlreadyDeleted = CommonConstant.NO;
        }
    ...
    public String getAllFirstChinese() {
        if (!"".equals(pinyinChinese)) {
            String[] words = this.pinyinChinese.split(",");
            ...
            this.allFirstChinese = sb.toString();
        }

        return allFirstChinese;
    }

    public void setAllFirstChinese(String allFirstChinese) {
        this.allFirstChinese = allFirstChinese;
    }

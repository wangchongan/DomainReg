 ...
 */
package com.jinmibao.biz.dao.common.impl;
 ...
 */
public class SysConfigDaoImpl extends GenericDaoImpl<SysConfigDO, SysConfigQuery> implements SysConfigDao {

    public static final String NS = "sysConfig";
